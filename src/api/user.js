...
class UserApi {
    async createUser(req, res) {
        ...
        try {
            ...
            return res.status(400).send({ error: `Erro ao criar user ${e.message}`})
        }
    }
    ...
    async updateUser(req, res) {
        ...
        try {
            ...
            return res.status(400).send({ error: `Erro ao alterar user ${e.message}`})
        }
    }
    ...
    async findUsers(req, res) {
        try {
            ...
            return res.status(400).send({ error: `Erro ao listar user ${e.message}`})
        }
    }
