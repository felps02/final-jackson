...
class TaskApi {
    ...
    async createTask(req, res) {
        ...
        try {
            ...
            return res.status(400).send({ error: `Erro ao criar  ${e.message}`})
        }
    }
    ...
    async updateTask(req, res) {
        ...
        try {
            ...
            return res.status(400).send({ error: `Erro ao alterar  ${e.message}`})
        }
    }
    ...
    async filterTask(req, res){
        ...
        try {
            ...
            return res.status(400).send({ error: `Erro ao filtrar  ${e.message}`})
        }
